...
aws ec2 run-instances --image-id ami-3883a55d --count 1 --instance-type t2.micro --key-name dc-devops-demo-envs --security-group-ids sg-f515cd9c --subnet-id subnet-5f17f824 --region us-east-2 
'''
